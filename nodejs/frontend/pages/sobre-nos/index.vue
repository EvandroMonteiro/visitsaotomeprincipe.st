<template>
  <main>
    ...
    <ModuloInformacoes />   
    <Razoes :items="razoes.razoes" :titulo="razoes.titulo" :texto="razoes.texto" />
  </main>
</template>
...
import ModuloSobreList from '../../components/ModuloSobreList.vue'

export default Vue.extend({
  components: { ModuloSobreList },
  data() {
    return {
      pagina: []
    }
