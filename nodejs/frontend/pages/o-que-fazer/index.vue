  ...
  <main>
    ...
    >
      <CarrouselCard arrowColor="#fff">
        <CardMiniCarrousel v-for="(categoria,indexCategorias) in categorias" :key="categoria.nome+indexCategorias"
          :titulo="categoria.nome"
          :link="categoria.locais_e_actividades[0] ? localePath('/o-que-fazer/' + categoria.locais_e_actividades[0].regiao.ilha.slug + '/' + categoria.slug) : '#'"
          :imagem="categoria.banner ? base_url(categoria.banner.url) : '/slide1.png'"
          class="swiper-slide"
        />
      </CarrouselCard>
    </Banner>
